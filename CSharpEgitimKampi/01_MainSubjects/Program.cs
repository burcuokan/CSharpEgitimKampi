...
namespace _01_MainSubjects
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            //Console.WriteLine("-----Pizza: " + hamburgerPrice + " TL ");
            //Console.WriteLine("-----Kola: " + hamburgerPrice + " TL ");
            //Console.WriteLine("-----Limonata: " + hamburgerPrice + " TL ");
            //Console.WriteLine("-----Kızartma: " + hamburgerPrice + " TL ");
            //Console.WriteLine("-----Su: " + hamburgerPrice + " TL ");
            //Console.WriteLine();
            //Console.WriteLine("*****Restoran Menü Fiyatı*****");
